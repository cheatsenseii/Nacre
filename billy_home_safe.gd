...
## Safe fallback based on the last pre-decoration house version.
...
func _interact(id: String) -> void:
	...
	match id:
		...
		"UrbexGear":
			...
			if line != "":
				var gear := get_node_or_null("UrbexGear")
				if gear != null:
					gear.hide()
		"FrontDoor":
